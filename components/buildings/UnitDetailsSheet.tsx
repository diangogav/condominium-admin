        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-[400px] sm:w-[540px] overflow-y-auto">
                <SheetHeader className="mb-6">
                    <SheetTitle className="text-2xl">Unidad {unit.name}</SheetTitle>
                    <SheetDescription>
                        Piso {unit.floor} • Alícuota {unit.aliquot}%
                    </SheetDescription>
                </SheetHeader>
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <Card>
                                <CardContent className="p-4 pt-4">
                                    <div className="text-sm font-medium text-muted-foreground">Deuda pendiente</div>
                        ...
                        <Tabs defaultValue="residents">
                            <TabsList className="w-full">
                                <TabsTrigger value="residents" className="flex-1">Residentes</TabsTrigger>
                                <TabsTrigger value="invoices" className="flex-1">Facturas</TabsTrigger>
                            ...
                            <TabsContent value="residents" className="mt-4 space-y-4">
                                <h3 className="text-sm font-medium flex items-center gap-2">
                                    <Users className="h-4 w-4" /> Residentes actuales
                                </h3>
                                {residents.length === 0 ? (
                                    <p className="text-sm text-muted-foreground">No hay residentes asignados a esta unidad.</p>
                                ) : (
                            ...
                            <TabsContent value="invoices" className="mt-4 space-y-4">
                                ...
                                {invoices.length === 0 ? (
                                    <p className="text-sm text-muted-foreground">No se encontraron facturas para esta unidad.</p>
                                ) : (
                            ...
                            <TabsContent value="payments" className="mt-4 space-y-4">
                                ...
                                {payments.length === 0 ? (
                                    <p className="text-sm text-muted-foreground">No se encontraron pagos para esta unidad.</p>
                                ) : (
                                    <div className="h-[300px] w-full pr-2 overflow-y-auto">
                                        <div className="space-y-3">
